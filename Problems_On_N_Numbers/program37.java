...
class Number
{
    public void OddDisplay(int Arr1[],int Size1, int Arr2[], int Size2)
    {
        System.out.println("Odd Elements of the first Array");
        ...
        System.out.println("Odd Elements of the Second Array");
...
class program37
{
    public static void main(String arg[])
    {
        ...
        obj.OddDisplay(Arr1,size1,Arr2,size2); 
    }
}
